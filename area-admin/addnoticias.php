...
<body>
    ...
    <div class="col-lg-6 offset-lg-3">
        <form action="includes/insertnoticias.php" method="post" class="border border-1 border-dark p-4" style="width: 100%; margin-top: 2%;">
            <div class="mb-3">
                <label for="driver-number" class="form-label">Id</label>
                <input type="text" class="form-control" name="Id" required placeholder="Id">
            </div>
            <div class="mb-3">
                <label for="driver-number" class="form-label">Data</label>
                <input type="text" class="form-control" name="Data" required placeholder="Data">
            </div>
            <div class="mb-3">
                <label for="driver-name" class="form-label">Titulo</label>
                <input type="text" class="form-control" name="Titulo" required placeholder="Titulo">
            </div>
            <div class="mb-3">
                <label for="team-name" class="form-label">Tema</label>
                <input type="text" class="form-control" name="Tema" required placeholder="Tema">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="team-name" class="form-label">Completa</label>
                <input type="text" class="form-control" name="Completa" required placeholder="Completa">
            </div>
            <div>
