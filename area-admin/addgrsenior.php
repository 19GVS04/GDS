...
<body>
    ...
    <div class="col-lg-6 offset-lg-3">
        <form action="includes/insertgrsenior.php" method="post" class="border border-1 border-dark p-4" style="width: 100%; margin-top: 2%;">
            <div class="mb-3">
                <label for="driver-number" class="form-label">Id</label>
                <input type="text" class="form-control" name="Id" required placeholder="Id">
            </div>
            <div class="mb-3">
                <label for="driver-number" class="form-label">Nome</label>
                <input type="text" class="form-control" name="Nome" required placeholder="Nome">
            </div>
            <div class="mb-3">
                <label for="driver-name" class="form-label">Idade</label>
                <input type="text" class="form-control" name="Idade" required placeholder="Idade">
            </div>
            <div class="mb-3">
