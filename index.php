...
<head>
	...
	<title>Grupo Desportivo Santacombadense</title>
...
<nav class="navbar">
  ...
  <div class="about">
    <div class="content">
      <div class="title">Grupo Desportivo Santacombadense</div>
        <h1 style="margin-top: 10px; margin-bottom:-15px;">
			     <img src="/GDS/images/ProjetoGDS/gdss.png" style="max-height: 140px; " alt="">
        </h1>
           <p>Bem-vindo ao site oficial do clube Grupo Desportivo Santacombadense. Tenha acesso a todas as actualidades e informações, calendário, resultados, pedido de adesão de sócio e veja ainda os elementos da equipa principal.     </p>
    </div>
  </div>
  <script>
...
<div class="slideshow-container" style="margin-top: 2%; ">
  <div class="mySlides fade">
    <img class="sombra" src="images/ProjetoGDS/Carousel1CC.jpg" style="width:100%">
  </div> 
  <div class="mySlides fade">        
    <img class="sombra" src="images/ProjetoGDS/senior1.jpg" style="width:100%">
  </div> 
  <div class="mySlides fade">     
    <img class="sombra" src="images/ProjetoGDS/Carousel2CC.jpg" style="width:100%">
  </div>
  <div class="mySlides fade">
    <img class="sombra" src="images/ProjetoGDS/Carousel4CC.jpg" style="width:100%">
  </div> 
  <div class="mySlides fade">
    <img class="sombra" src="images/ProjetoGDS/socio.jpg" style="width:100%">
  </div>
</div>
  <div class="tm"  style="text-align: center; ">
		<img  src="images/ProjetoGDS/FPF.png" style="height: 100px; margin-top: 12px; "alt="">	
	</div>
...
<!-- Newsletter-->
<div style="box-shadow: 0px 20px 10px -15px rgba(0,0,0,0.49);" class="container-news">
    <form action="includes/insertnewsletter.php" method="POST">
      <h1 style="-webkit-text-stroke: 2px black;" >Subscreva já a nossa Newsletter</h1>
      <p class="toma">Quer receber todas as novidades do Grupo Desportivo Santacombadense? Subscreva já a nossa Newsletter!</p> 
      <div class="email-box">
        <i style="background: #1b1b1b;" class="fas fa-envelope"></i>
        <input class="tbox input" type="email" id="Email" name="Email" placeholder="Introduzir Email" required>
        <button class="btn" type="submit" name="submit">Subscrever</button>
      </div>
    </form>
</div>
...
?>
  <div class="container-card" style="margin-top: 1%;">
     <div class="about">
      ...
      <div class="column-card" style="margin-top: 1%;">
        <?php 
    ...
    <script src="js/popup.js"></script> -->
      ...
      <a href="nnoticias.php" class="allbtn">Ver todas as notícias </a>
    </div>
</div>
