...
<nav class="navbar">
  ...
  <div class="about">
    <div class="content">
      ...
      <p>O GD Santacombadense para além de potenciar grandes talentos, também tem o objetivo de formar grandes pessoas. É assim que se trabalha desde que se entra nesta família até ao úlitmo jogo no escalão mais alto.</p>
      <p>São abertas épocas de inscrições e de treinos de captação para todos terem a oportunidade de tentar respresentar esta grande ínstituição, as mesmas serão divulgadas nas redes sociais e noticiadas no nossso website.</p>
    </div>
  </div>
<script>
